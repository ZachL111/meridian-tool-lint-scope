...
`meridian-tool-lint-scope` is centered on cli tools work in Python. The technical target is: Package a Python local lab for lint analysis with transition tables, invalid-transition tests, and documented operating limits.
