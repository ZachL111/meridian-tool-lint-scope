"""Regression checks for the meridian-tool-lint-scope casebook."""
...
from casebook.harness import assert_expected, meridian_tool_lint_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_tool_lint_scope_summary(), assert_expected())
