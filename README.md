...
meridian-tool-lint-scope is a Python project for cli tools. It focuses on this technical goal: Package a Python local lab for lint analysis with transition tables, invalid-transition tests, and documented operating limits.
